...
//import com.sahayogmultistate.it.kyc.repository.KycTascRepository;
//import java.io.File;
...
//
//@Service
//public class KycTascService {
//
//    @Autowired
//    private KycTascRepository repository;
//
//    @Autowired
...
//
//    public KycTasc add(MultipartFile[] idProof, MultipartFile[] addressProof,
//            MultipartFile[] pan, MultipartFile[] tascDoc, MultipartFile[] otherDoc,
//            MultipartFile[] clientForm, String accountType, String branchName,
//            String entity, String applicantFirst, String applicantSecond,
//            String applicantThird, String applicantFourth, String applicantFifth,
//            long mobileNo, String adharNoFirst, String adharNoSecond,
//            String adharNoThird, String adharNoFourth, String adharNoFifth,
//            String status, String remark, Date date, String idProofStatus,
//            String addressProofStatus, String panStatus, String tascDocStatus,
...
//        KycTasc record = new KycTasc();
//        KYCRecord byAdhar;
//        if ("TASC".equals(accountType)) {
...
//                File directoryForTascDocs = new File(directoryPath + "//" + "tascDoc");
...
//                deleteDirectory(directoryForTascDocs);
...
//                }
//
//                directoryForTascDocs.mkdirs();
//                int loopTascDoc = tascDoc.length;
//                for (int i = 0; i < loopTascDoc; i++) {
//                    try (FileOutputStream fosTascDoc = new FileOutputStream(new File(directoryForTascDocs, "tascDoc_" + i))) {
//                        fosTascDoc.write(tascDoc[i].getBytes());
//                    }
//                }
//
...
//                record.setApplicantFourth(applicantFourth);
//                record.setApplicantFifth(applicantFifth);
...
//                record.setAdharNoFourth(adharNoFourth);
//                record.setAdharNoFifth(adharNoFifth);
...
//                record.setTascDocStatus(tascDocStatus);
...
//    }
//
//    public KycTasc update(MultipartFile[] idProof, MultipartFile[] addressProof,
//            MultipartFile[] pan, MultipartFile[] tascDoc, MultipartFile[] otherDoc,
...
//            String approvedBy, String uploadedBy, String timeStam
//    ) throws IOException {
//        KycTasc record = getKycRecordById(id);
...
//    }
//
//    public KycTasc update(long id, String accountType, String branchName,
//            String entity, String applicantFirst, String applicantSecond,
//            String applicantThird, String applicantFourth, String applicantFifth,
//            long mobileNo, String adharNoFirst, String adharNoSecond,
//            String adharNoThird, String adharNoFourth, String adharNoFifth,
...
//    }
//
//    public List<KycTasc> getAllKYCRecordsFromDB() {
//        return repository.findAll();
//    }
//
//    public List<KycTasc> getAllKycRecords() {
//        ArrayList<KycTasc> recordList = new ArrayList<>();
//        List<KycTasc> findAll = getAllKYCRecordsFromDB();
//        if (!findAll.isEmpty()) {
//
//            for (KycTasc kYCRecord : findAll) {
//
...
//                File[] retrieveFilesForTascDoc = retrieveFilesForTascDoc(branchName, accountType, code);
...
//
//                    List<byte[]> arrayListForTascDoc = new ArrayList<>();
//                    for (File file : retrieveFilesForTascDoc) {
//                        arrayListForTascDoc.add(Files.readAllBytes(file.toPath()));
//                    }
//                    kYCRecord.setTascDoc(arrayListForTascDoc);
//
...
//                    Logger.getLogger(KycTasc.class.getName()).log(Level.SEVERE, null, ex);
//                }
//            }
//            return recordList;
//        } else {
...
//
//    @Transactional
//    public List<KycTasc> getAllKycRecordsByUserName(String userName) {
//        ArrayList<KycTasc> recordList = new ArrayList<>();
//        BranchAccess user = service.getUser(userName);
//        ArrayList<String> branchNameList = user.getBranchNameList();
////         -->
//        ArrayList<KycTasc> kYCRecords = new ArrayList<>();
//        for (String branchName : branchNameList) {
//            List<KycTasc> findAllByBranchName = repository.findAllByBranchName(branchName);
//            for (KycTasc kYCRecord : findAllByBranchName) {
//                kYCRecords.add(kYCRecord);
//            }
//        }
////        <--
//
//        for (KycTasc kYCRecord : kYCRecords) {
//
//            String branchName = kYCRecord.getBranchName();
//            String accountType = kYCRecord.getAccountType();
//            String code = kYCRecord.getCode();
...
//
//    @Transactional
//    public List<KycTasc> getAllKycForUserBranches(String userName) {
//        BranchAccess user = service.getUser(userName);
//        ArrayList<String> branchNameList = user.getBranchNameList();
//
////         -->
...
//    }
//
//    public List<KycTasc> getAllKycRecordsForBranch(String branchname) {
//
//        ArrayList<KycTasc> recordList = new ArrayList<>();
//        List<KycTasc> findAllByBranchName = repository.findAllByBranchName(branchname);
//        for (KycTasc kYCRecord : findAllByBranchName) {
...
//    }
//
//    public List<KycTasc> getKycRecordsByAadharNo(String adharNo) {
//        ArrayList<KycTasc> recordList = new ArrayList<>();
//        List<KycTasc> findAll = getAllKYCRecordsFromDB();
//        for (KycTasc kYCRecord : findAll) {
...
//    }
//
//    public KycTasc getKycRecordById(long id) {
//        Optional<KycTasc> optional = repository.findById(id);
//        if (optional.isPresent()) {
//            KycTasc kYCRecord = optional.get();
//
//            String branchName = kYCRecord.getBranchName();
//            String accountType = kYCRecord.getAccountType();
//            String code = kYCRecord.getCode();
...
//        List<KycTasc> arrayList = getAllKYCRecordsFromDB();
...
//    }
//
//    public File[] retrieveFilesForTascDoc(String branchName, String accountType, String code) {
//
//        String directoryPath = ROOT_F + "//" + branchName + "//" + "CASA" + "//" + "Non_Individual" + "//" + accountType + "//" + code + "//" + "tascDoc";
//        File directory = new File(directoryPath);
//        if (directory.exists() && directory.isDirectory()) {
//            File[] files = directory.listFiles();
//
...
//    }
//
//    private List<KycTasc> findByAdharNoAndaccountType(String OldAdharNo, String OldAccountType) {
//        ArrayList<KycTasc> recordList = new ArrayList<>();
//        List<KycTasc> findAll = getAllKYCRecordsFromDB();
//        if (!findAll.isEmpty()) {
//
...
//    }
//
//    public KycTasc findByCode(String code) {
//        KycTasc findByCode = repository.findByCode(code);
//        KycTasc ksac = getKycRecordById(findByCode.getId());
//        return ksac;
//    }
//}
